      ...
      <footer className="footer">
        <div className="footer__container">
          <div className="footer_left">
            ...
            <p>123, Civil Lines, Near City Mall, Bareilly, Uttar Pradesh - 243001, India</p>

            <div className="footer_address">
              <strong> sale@invertix.com </strong>
              <strong> +91 9458866751 </strong>
            </div>
        ...
        <div className="footer_bottom">
          <p>
            © {getCurrentYear()} Invertix. All Rights Reserved | Made By{" "}
            <a
              href="https://github.com/Anwar6777"
              target="_blank"
              rel="noreferrer"
